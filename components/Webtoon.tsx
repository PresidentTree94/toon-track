...
export default function Webtoon({ data }:Readonly<{ data: Toon; }>) {
  return (
    <Link href={`/webtoon/${data.id}`} className="bg-card shadow-sm rounded-2xl overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
